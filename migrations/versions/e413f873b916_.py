...
revision = 'e413f873b916'
down_revision = '641e51d530ff'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('component', sa.VARCHAR(length=200), nullable=False),
    sa.Column('user_id', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_prompt_user_id_user', ondelete='CASCADE'),
